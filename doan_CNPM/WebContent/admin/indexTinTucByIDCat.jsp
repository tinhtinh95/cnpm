...
<div id="content">
  ...
  %>
    <div id="breadcrumb"> <a href="<%=request.getContextPath() %>/admin/home" title="Về trang chủ" class="tip-bottom"><i class="icon-home"></i>Trang chủ</a> 
    <a href="<%=request.getContextPath() %>/admin/category">Danh mục</a> 
    <a href="javascript:void(0)" class="current"></a><%=nameCat %> </div>
    <h1 style="text-align:center"><%=nameCat %></h1>
  </div>
