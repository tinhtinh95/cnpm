...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="<%=request.getContextPath() %>/admin/home" title="Về trang chủ" class="tip-bottom"><i class="icon-home"></i>Trang chủ</a> <a href="<%=request.getContextPath() %>/admin/news">Tin tức</a> <a href="javascript:void(0)" class="current">Thêm tin tức</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form onsubmit="return check()" class="form-horizontal" enctype="multipart/form-data" method="post" action="" name="form1" id="addNews">
              <div class="control-group">
	              <label class="control-label">Tên tin tức(*)</label>
	              <div class="controls">
	                <input class="span8" type="text" name="name_news" placeholder="">
	              </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
	              ...
	              <div class="controls">
	                ...
	                <p style="color: red;font-size: 15px" id="hinhanh"></p>
	              </div>
              </div>
              <div class="control-group">
	              <label class="control-label">Mô tả(*)</label>
	              <div class="controls">
	                <textarea class="span11" name="preview" ></textarea>
	              </div>
              </div>
              <div class="control-group">
              ...
              <div class="control-group">
                <div class="controls">
	                <input type="submit" name="them" value="Thêm tin tức" class="btn btn-success">
            ...
            <script type="text/javascript">
					...
					$("#addNews").validate({
						...
						messages:{
							...
							preview:{
								...
								maxlength: "<span style='color:red'>Tối đa 200 kí tự!</span>",
							},
							detail:{
				...
				function check(){
					...
					if(picture == ""){
						document.getElementById("hinhanh").innerHTML = "Chưa chọn hình ảnh!";
						check = false;
					}
					if(check==true) document.getElementById("hinhanh").innerHTML = "";
					return check;
				}
			</script>
          </div>
